...
про то что из-за уменьшения объема вдоха будет не хватать кислорода, и скоро начнет сдавать сердце, что устаю из-за того что в плечах переживаются вены и артерии. Про соли вроде бы это сказки, но по ощущениям, как будто кости 
...
Andrew Ng "добавление статистики часто улучшает качество алгоритма". тут не статистика движения, а статистика НА движениЕ - шум и раздолбайство это дополнительные похоже репрезентативные сэмплы
